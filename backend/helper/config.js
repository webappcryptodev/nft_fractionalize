...
const config = {
    ...
    eth_http: "https://rinkeby.infura.io/v3/9aa3d95b3bc440fa88ea12eaa4456161",
    ct_addr: '0x9B1b14A53E9fdBa4d2e29A0c5Dc146d0E817D9db',
    ct_abi: [
      {
        "anonymous": false,
        "inputs": [
    ...
    baseUri: 'https://protomock.com:5000/item/view/',
    collection_abi: [
      {
        "inputs": [
          {
